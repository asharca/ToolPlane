...
export function ContextMenuTrigger({
  ...
  const { triggerRef, ...context } = useContextMenuContext("ContextMenuTrigger");
  ...
  // eslint-disable-next-line react-hooks/refs -- cloneElement receives a callback ref; mutable refs are read only on commit/events.
...
export function ContextMenuContent({
  ...
  const { triggerRef, contentRef, ...context } = useContextMenuContext("ContextMenuContent");
