  ...
  return (
    <form action={deleteAgentAction} className="flex flex-wrap items-center gap-2.5">
      ...
      <ConfirmSubmitButton
        ...
        triggerClassName="inline-flex size-10 shrink-0 items-center justify-center rounded-md border border-red-200 p-0 text-red-600 transition-colors hover:bg-red-50 dark:border-red-500/30 dark:text-red-400 dark:hover:bg-red-950/30"
