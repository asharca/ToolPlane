...
export function AgentSettings({
  ...
  return (
    <DashboardPage className="space-y-0">
      <section className="flex min-h-[calc(100dvh-8rem)] flex-col overflow-hidden border-y border-border bg-background lg:border">
