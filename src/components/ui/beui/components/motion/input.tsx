// Source: asharca/ui 85b080aafe2f7e3aaf720e5a2ffdf035289c49c1/components/motion/input.tsx (MIT). See provenance.json.
"use client";
...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  const inputElement = (
        <input
          ...
          {...rest}
          onChange={(e) => { onNativeChange?.(e); handleChange(e.currentTarget.value); }}
          onFocus={(event) => {
            setFocused(true);
            onFocus?.(event);
          }}
